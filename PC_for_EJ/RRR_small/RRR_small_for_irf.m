function [A, B ,C_final, D_final ,add_matrices,inv_shock_std] = RRR_small( params,setup,data )
%code solves the model with sticky prices  as price indexation from the JME (2005) paper
...
pi_matrix(16,3)=1;
 ...
 inv_shock_std=1/D(r,3); %uncomment this for real rate application
 %inv_shock_std=1/D(a,1); %this is for output application
